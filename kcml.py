...
kifli = LineClient(authToken='EEGhq4o16wp2kbbnC0Y3.qxR6qp9lW4DbdlW1mC5OuW.IWP1MI2ft64ktQyh7VvF3EjOz8rtMrsUA5WUnAzUkgQ=')
...
staff = ["u417afa40ff4bc387410cbc3531ce6853"]
...
def help2():
    ...
    helpMessage2= "      「✭SETTING✭」\n" + \
                  ...
                  "❂͜͡➣ " + key + "Apakah「ᴛᴇxᴛ」\n" + \
                  "❂͜͡➣ " + key + "KCML「ᴛᴇxᴛ」」\n" + \
                  "❂͜͡➣ " + key + "Berapa besar dosa「ᴛᴇxᴛ」\n" + \
                  "❂͜͡➣ " + key + "Berapa besar amal「ᴛᴇxᴛ」\n" + \
                  " [🔑KCML]🕸"
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  kifli.sendContact(op.param1, "u417afa40ff4bc387410cbc3531ce6853")
...
#===========Hiburan============#
                        ...
                        elif "KCML " in msg.text:
                            tanya = msg.text.replace("KCML ","")
                            jawab = ("TIDAK","YA")
                            jawaban = random.choice(jawab)
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               kifli.sendMessage(msg.to, "[Progress....].")
                               elapsed_time = time.time() - start
                               kifli.sendMessage(msg.to, "Speed".format(str(elapsed_time)))

                        elif cmd == "harga":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               kifli.sendMessage(msg.to, "╭══════════\n║⚫─[     DAFTAR HARGA     ]─⚫ \n║SELFBOT ONLY = 75K /BLN\n║2 ASSIST = 100K /BLN\n║5 ASSIST = 200K /BLN\n║10 ASSIST = 300K /BLN\n║\n║PROTECT ANTIJS\n║\n║2 BOT + ANTIJS = 150K /BLN\n║5 BOT + ANTIJS = 300K /BLN\n║10 BOT + ANTIJS = 500K /BLN\n║\n║═ই\═ANDA BERMINAT\n║ SILAHKAN ADD CONTACT \n║ DIBAWAH INI   \n║\n║http://line.me/ti/p/~akshalrg12\n║       TERIMA KASIH      \n║\n╰════════════")
